			...
			<div class="layui-card">
				<div class="layui-card-header">
					...
					<button type="button" class="layui-btn layui-btn-sm layui-btn-add">
						<i class="layui-icon layui-icon-addition"></i>新增父目录
					</button>
					<!-- 新增按钮 结束 -->
				</div>
...
<input type="hidden" id="hideURL" value="dictionaries"/>
...
<!-- 引入自定义的JS脚本 -->
<script type="text/javascript" src="assert/pages/js/dictionaries.js"></script> 
